 ...
 * @Author		S.Hayashi
 *
 * Updated to 1.20.1 on 2015-03-06
...
<?php
    ...
    protected function _check_confirm($booking_id=0)
    {
        ...
        $ret = $this->_set_confirmed($booking_id);
	...
	public function column_default($item, $column_name) {
		...
		switch ($column_name) {
			...
			case 'confirmed' :
                ...
                return sprintf('<a href="javascript:void(0)" onclick="mtssb_list_op.confirm(this, %d)"><img src="%s"></a>', $item['booking_id'], $url);
			case 'paid' :
